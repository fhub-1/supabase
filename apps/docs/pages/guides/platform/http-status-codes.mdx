...
The Supabase platform offers several HTTP APIs for each project. These APIs can use the status codes to indicate the state of the project, and the request being processed.
...
-- TODO (darora): add links to log explorer/performance page, and tips on troubleshooting and resolving 5xx errors
-- Additionally, we should add a page explaining segregation of compute resources, and why 5xx errors for a project might not show up on our Service-wide statuspage
